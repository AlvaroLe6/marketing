...
<template>
  ...
  <v-row>
    <v-col cols="12" class="text-center">
      <h2>
        {{ certificadoData.nombre }}</h2>
      <v-text class="text-span-asesor"> 
        Asesor : {{certificadoData.nombre_asesor}}</v-text>
    </v-col>
  </v-row>

  <v-row>
   <!-- https://esammarketingapi-36cc8f6bb2a2.herokuapp.com/api/add_person_and_inscription -->
  <!--<img v-if="fondoCertificado" :src="`http://localhost:3000${fondoCertificado.Ruta}`" alt="Fondo del certificado">-->
    <v-col cols="12" md="6" class="d-flex flex-column"> 
      <img v-if="fondoCertificado" :src="`https://esammarketingapi-36cc8f6bb2a2.herokuapp.com${fondoCertificado.Ruta}`" alt="Fondo del certificado">
  ...
  <v-row>
    ...
    <v-col cols="12" class="d-flex justify-center align-center">
      <v-btn @click="handleClick">Reservar plaza</v-btn>
    </v-col>
  </v-row>
